...
class PaymentServiceTest {
    ...
    void processPayment_Success() {
        doReturn(samplePayment).when(paymentRepository).save(org.mockito.ArgumentMatchers.isA(Payment.class));
        when(receiptRepository.save(org.mockito.ArgumentMatchers.isA(Receipt.class))).thenReturn(sampleReceipt);
    ...
    void processPayment_SimulatedFailure_ThrowsException() {
        ...
        verify(paymentRepository, times(1)).save(any(Payment.class));
        verify(receiptRepository, never()).save(org.mockito.ArgumentMatchers.isA(Receipt.class));
    }
